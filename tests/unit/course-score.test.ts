...
describe("course pair ranking", () => {
  it("pairs a meal with a nearby cafe deterministically", () => {
    const pairs = rankCoursePairs({
      ...
      center: { latitude: 35.15, longitude: 126.85 }, mealCategory: "grill", second: "cafe", radiusKm: 3,
    });
  ...
  it("expands the second-place distance from 1.5km to 3km", () => {
    const pairs = rankCoursePairs({
      ...
      center: { latitude: 35.15, longitude: 126.85 }, mealCategory: "all", second: "dessert", radiusKm: 5,
    });
  ...
  it("keeps low-sample ratings neutral and marks them", () => {
    const pairs = rankCoursePairs({
      ...
      center: { latitude: 35.15, longitude: 126.85 }, mealCategory: "all", second: "cafe", radiusKm: 3,
    });
