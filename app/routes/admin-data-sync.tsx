...
import { buildAutoClassificationReviewUrl } from "../features/candidates/auto-classification-navigation";
...
export async function action({ request }: Route.ActionArgs) {
  ...
  await syncPublicDataBatch(createDb(env.DB), {
    ...
    sourceType: String(form.get("sourceType")) as PublicDataSource,
    addressField: String(form.get("addressField")) as AddressField,
  });
  return redirect(buildAutoClassificationReviewUrl());
}
